      ...
      <header className="px-safe-pad pt-8 pb-6 bg-white rounded-b-[2rem] shadow-sm">
        ...
        <div className="relative">
          ...
          <Input 
            ...
            className="h-14 pl-12 rounded-2xl border-none bg-muted/30 focus-visible:ring-primary"
          />
        </div>
      </header>
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
            {["🌴 Island", "⛰️ Mountain", "🗼 City", "🏛️ History", "🍝 Food"].map((mood) => (
              <Badge 
                key={mood} 
                variant="outline" 
                className="whitespace-nowrap px-4 py-2 rounded-xl border-primary/20 bg-white text-sm font-bold"
              >
                {mood}
              </Badge>
            ))}
