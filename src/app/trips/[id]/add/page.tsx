      ...
      <Dialog open={showGuestPrompt} onOpenChange={setShowGuestPrompt}>
        <DialogContent className="max-w-[calc(100vw-40px)] w-full rounded-[2.5rem] p-0 border-none shadow-2xl bg-white overflow-hidden animate-in fade-in zoom-in-95 duration-300">
          <div className="h-44 sm:h-52 bg-foreground relative flex flex-col items-center justify-center overflow-hidden pt-6">
             <div className="absolute h-56 w-56 bg-accent/20 rounded-full blur-[80px] animate-pulse" />
             
             <div className="relative z-10 flex items-center justify-center">
               <div className="absolute h-40 w-40 rounded-full border border-accent/20 animate-ping duration-[3.5s]" />
               <div className="absolute h-36 w-36 rounded-full border border-accent/30 animate-ping duration-[4.5s]" />
               <div className="h-32 w-32 bg-accent/5 backdrop-blur-sm rounded-full flex items-center justify-center text-accent">
                 <svg width="140" height="140" viewBox="340 220 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
